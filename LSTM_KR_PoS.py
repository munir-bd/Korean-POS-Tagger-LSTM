def lstm_kr_pos (test_file):
    ...
    # for line in lines[: min(num_samples, 5)]:
        if len(line.strip()) != 0:
            input_text, target_text = line.split(' ')
            # print("input_text ", input_text)
            # print("target_text ", target_text)
            target_text = ' ' + target_text + '\n'
            # print("target_text_2 ", target_text)
    ...
    # Save LSTM model
    model.save('s2s_pos_kr_v10000.h5')
    ...
    # Save model encoder and decoder model
    with open('encoder_model_pos_kr_v10000.json', 'w', encoding='utf8') as f:
        f.write(encoder_model.to_json())
    encoder_model.save_weights('encoder_model_weights_pos_kr_v10000.h5')

    with open('decoder_model_pos_kr_v10000.json', 'w', encoding='utf8') as f:
        f.write(decoder_model.to_json())
    decoder_model.save_weights('decoder_model_weights_pos_kr_v10000.h5')
